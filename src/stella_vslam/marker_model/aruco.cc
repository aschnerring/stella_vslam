...
aruco::aruco(double width, int marker_size, int max_markers, int max_id_marker)
    : base(width, max_id_marker), marker_size_(marker_size), max_markers_(max_markers), max_id_marker_(max_id_marker) {
...
std::ostream& operator<<(std::ostream& os, const aruco& params) {
    ...
    os << "- max_id_marker: " << params.max_id_marker_ << std::endl;
