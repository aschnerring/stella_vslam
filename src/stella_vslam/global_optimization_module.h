...
private:
    ...
    //! Correct the positions of the markers which are seen in covisibilities
    void correct_covisibility_markers(const module::keyframe_Sim3_pairs_t& Sim3s_nw_before_correction,
